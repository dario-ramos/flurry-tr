...
#ifndef lint
static const char rcsid[] = "$Id: utils.c,v 1.191 2019/09/24 07:00:57 mjl Exp $";
#endif
                       ...
                       size_t olen)
{
  static const uint8_t b[] =
    { 2, 6, 6, 6, 10, 10, 10, 14, 14, 14, 18, 18, 18, 22, 22, 22, 26, 26, 26,
        30, 30, 30, 34, 34, 34, 38, 38, 38, 42, 42, 42, 46, 46, 46, 50, 50, 50,
        54, 54, 54, 58, 58, 58, 62, 62, 62 };
...
int fd_lines (int fd, int (*func) (char*, void*), void *param)
{
  ...
  while ((ss = read (fd, readbuf + readbuf_off, readbuf_len - readbuf_off - 1))
      >= 0)
  {
    start = 0;
    off = 0;

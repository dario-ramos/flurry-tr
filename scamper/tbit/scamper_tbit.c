...
char* scamper_tbit_type2str(const scamper_tbit_t *tbit, char *buf, size_t len)
{
  static char *t[] =
    {
    NULL, "pmtud", "ecn", "null", "sack-rcvr", "icw", "abc", "blind-data",
        "blind-rst", "blind-syn", "blind-fin", };
...
char* scamper_tbit_res2str(const scamper_tbit_t *tbit, char *buf, size_t len)
{
  static char *t[] =
    { "none", /* 0 */
    "tcp-noconn", "tcp-rst", "tcp-error", "sys-error", "aborted",
        "tcp-noconn-rst", "halted", "tcp-badopt", "tcp-fin", "tcp-zerowin", /* 10 */
        NULL,
        NULL,
        NULL,
        NULL,
        ...
        NULL,
        NULL, "pmtud-noack", /* 20 */
        "pmtud-nodata", "pmtud-toosmall", "pmtud-nodf", "pmtud-fail",
        "pmtud-success", "pmtud-cleardf",
        NULL,
        NULL,
        NULL, "ecn-success", /* 30 */
        "ecn-incapable", "ecn-badsynack", "ecn-noece", "ecn-noack",
        "ecn-nodata",
        NULL,
        NULL,
        NULL,
        NULL, "null-success", /* 40 */
        "null-nodata",
        NULL,
        NULL,
        NULL,
        ...
        NULL,
        NULL,
        NULL, "sack-incapable", /* 50 */
        "sack-rcvr-success", "sack-rcvr-shifted", "sack-rcvr-timeout",
        "sack-rcvr-nosack",
        NULL,
        NULL,
        NULL,
        ...
        NULL,
        NULL,
        NULL, "blind-accepted", /* 80 */
        "blind-challenge", "blind-ignored", "blind-rst", "blind-synnew", };
...
void scamper_tbit_free(scamper_tbit_t *tbit)
{
  ...
  if (tbit->src != NULL)
    scamper_addr_free (tbit->src);
  if (tbit->dst != NULL)
    scamper_addr_free (tbit->dst);
  if (tbit->list != NULL)
    scamper_list_free (tbit->list);
  if (tbit->cycle != NULL)
    scamper_cycle_free (tbit->cycle);

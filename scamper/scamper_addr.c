...
static const struct handler handlers[] =
  {
    {
    SCAMPER_ADDR_TYPE_IPV4, 4, ipv4_cmp, ipv4_human_cmp, ipv4_tostr,
        ipv4_inprefix, ipv4_prefix, ipv4_prefixhosts, ipv4_islinklocal,
        ipv4_netaddr,
        NULL, ipv4_isreserved, ipv4_bit, ipv4_fbd, },
    {
    SCAMPER_ADDR_TYPE_IPV6, 16, ipv6_cmp, ipv6_human_cmp, ipv6_tostr,
        ipv6_inprefix, ipv6_prefix,
        NULL, ipv6_islinklocal, ipv6_netaddr, ipv6_isunicast, ipv6_isreserved,
        ipv6_bit, ipv6_fbd, },
    {
    SCAMPER_ADDR_TYPE_ETHERNET, 6, ethernet_cmp, ethernet_cmp, ethernet_tostr,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL, ethernet_bit, ethernet_fbd, },
    {
    SCAMPER_ADDR_TYPE_FIREWIRE, 8, firewire_cmp, firewire_cmp, firewire_tostr,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL, firewire_bit, firewire_fbd, } };
